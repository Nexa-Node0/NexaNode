<x-filament::section :aside="true" :collapsible="true" :icon="'heroicon-s-shield-check'" :heading="__('filament-breezy::default.profile.2fa.title')" :description="__('filament-breezy::default.profile.2fa.description')">
