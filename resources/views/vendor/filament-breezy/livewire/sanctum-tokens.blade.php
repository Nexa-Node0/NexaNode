<x-filament::section :aside="true" :collapsible="true" :icon="'heroicon-s-key'" :heading="__('filament-breezy::default.profile.sanctum.title')" :description="__('filament-breezy::default.profile.sanctum.description')">
    @if($plainTextToken)
